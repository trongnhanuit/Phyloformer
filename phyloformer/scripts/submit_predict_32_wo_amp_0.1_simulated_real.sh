...
batch_size=32
dropout="_0.1"
model_name="LR_0.0004_O_Adam_L_L2_E_185_BS_32NB_6_NH_4_HD_64_D_0.1.best_checkpoint.pt.best_model.pt"
epoch="23"
training_src="_simulated"
data_src="_real"
DATA_DIR="data/aa/"
...
mv -f ${PHYLOFORMER_DIR}scripts/predict_${batch_size}_${name}${dropout}${training_src}${data_src}_${epoch}.log ${PHYLOFORMER_DIR}data/training_full_parallel_batch_${batch_size}_${name}${dropout}${training_src}/
mv -f ${PHYLOFORMER_DIR}scripts/evaluate_${batch_size}_${name}${dropout}${training_src}${data_src}_${epoch}.log ${PHYLOFORMER_DIR}data/training_full_parallel_batch_${batch_size}_${name}${dropout}${training_src}/
mv ${PHYLOFORMER_DIR}scripts/scatter_predicted_true_distances.png ${PHYLOFORMER_DIR}data/training_full_parallel_batch_${batch_size}_${name}${dropout}${training_src}/scatter_${batch_size}_${name}${dropout}${training_src}${data_src}_${epoch}.png
